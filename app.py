...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'apexbuilt-construction-secret-2026'

# ============================================
# SERVICES WITH BETTER IMAGES
# ============================================
SERVICES = [
    {
    ...
    },
    {
        ...
        'image': 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=600&h=400&fit=crop&q=80',
...
TESTIMONIALS = [
    {
        ...
        'rating': 5,
        'text': 'APEXBUILT completely transformed our kitchen! The team was professional, on time, and the quality of work exceeded our expectations.',
    ...
    },
    {
        ...
        'rating': 5,
        'text': 'We hired APEXBUILT for a bathroom renovation and couldn\'t be happier. They listened to our vision and brought it to life beautifully.',
    ...
    },
    {
        ...
        'rating': 5,
        'text': 'The team at APEXBUILT did an amazing job on our home addition. Professional, reliable, and the craftsmanship is top-notch.',
...
def contact():
    if request.method == 'POST':
        ...
        return render_template('contact.html', 
            success=True, 
            name=name,
            message='Thank you for contacting APEXBUILT! We will respond within 24 hours.'
        )
